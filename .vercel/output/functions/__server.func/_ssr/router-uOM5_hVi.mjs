...
//#region node_modules/.nitro/vite/services/ssr/assets/router-uOM5_hVi.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-sm border border-border bg-surface-2 px-2.5 py-1.5 text-xs text-fg shadow-panel", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-C70LcMFg.css";
var APP_NAME = "SVD Fabric";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Rootless Podman BGP-EVPN lab: ER4 underlay, GRE and IPsec VTI, FRR VTEPs, Single VXLAN Device. Download labctl."
			},
			{
				name: "theme-color",
				content: "#090b0a"
...
var $$splitComponentImporter = () => import("./routes-Dhee-0dU.mjs");
